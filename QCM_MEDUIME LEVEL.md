...
36. Qu'est ce qu'un système autonome ?
- [ ] Un host qui est seul sur un réseau
- [ ] La configuration d'un DNS en mode autonome
- [ ] Un operating System concurrent de Linux
- [ ] un groupe de réseaux IP possédant une politique de routage propre et indépendante


37. Quel protocole est non routable ?
- [ ] IP
- [ ] ICMP
- [ ] Arp
- [ ] IGMP
...
38. A quelle syntaxe correspond un masque de type /19 ?
- [ ] 255.224.0.0
- [ ] 255.255.224.0
- [ ] 255.255.240.0
- [ ] 255.240.0.0
...
39. Quelle est l'adresse IP qui n'est pas routée sur Internet ?
- [ ] 15.89.76.32
- [ ] 196.234.265.89
- [ ] 184.45.256.99
- [ ] 172.31.98.2
...
40. Comment est gérée la Sliding Windows ?
- [ ] Grâce au champs Reserved
- [ ] Par tirage aléatoire après chaque réception
- [ ] Par tirage aléatoire après chaque envoi
- [ ] Grâce au champs Windows


41. Quelle est la couche du modèle OSI correspondante au protocole ARP ?
- [ ] 1
- [ ] 2
- [ ] 4
- [ ] 3
...
42. Comment travaille l'application Ping ?
- [ ] elle envoie un datagramme TCP de type Rst
- [ ] elle envoie un datagramme ICMP de type echo
- [ ] Elle synchronise l'horloge
- [ ] Elle synchronise la fréquence du CPU


43. Quelle est la couche du modèle TCP/IP correspondante au protocole ARP ?
- [ ] Application
- [ ] Internet
- [ ] Accès réseau
- [ ] Transport
...
44. Quelle est la couche du modèle OSI correspondante au protocole ICMP ?
- [ ] 2
- [ ] 1
- [ ] 3
- [ ] 4
...
45. Quelle est la taille de l'entête RARP ?
- [ ] 28 octets
- [ ] 8 octets
- [ ] 20 octets
- [ ] 16 octets
